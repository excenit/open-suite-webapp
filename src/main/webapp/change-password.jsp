  ...
  <body>
        ...
        <div class="alert alert-block alert-error text-center">
          ...
          <form id="login-form" action="<%=callbackUrl%>" method="POST">
            <div class="form-fields">
              ...
              <div class="fit-in-password">
                <span id="iconShowConfirmPassword">
                  <i class="fa fa-eye" aria-hidden="true"></i>
                </span>
    ...
    $(function(){
      ...
      if(browser.getBrowser().name === "Microsoft Edge"){
        ...
        $('#iconShowNewPassword').hide(); //Hide the show new password button
        $('#iconHideNewPassword').hide(); //Hide the hide new password button

        $('#iconShowConfirmPassword').hide(); //Hide the show confirm password button
      ...
      function hidePassword(iconShow,iconHide,passwordId){
      ...
      showPassword('#iconShowPassword','#iconHidePassword','#passwordId');
      hidePassword('#iconShowPassword','#iconHidePassword','#passwordId');

      showPassword('#iconShowNewPassword','#iconHideNewPassword','#newPasswordId');
      hidePassword('#iconShowNewPassword','#iconHideNewPassword','#newPasswordId');

      showPassword('#iconShowConfirmPassword','#iconHideConfirmPassword','#confirmPasswordId');
      hidePassword('#iconShowConfirmPassword','#iconHideConfirmPassword','#confirmPasswordId');
